...
public class BaseDatos extends SQLiteOpenHelper {
    ...
    public ArrayList<Mascota> recuperarMascotasFavoritas(){
        ArrayList<Mascota> mascotas = new ArrayList<>();

        String query = "SELECT a.*, b.num_likes FROM mascota a, likes b WHERE a.id = b.id AND b.num_likes < 50 ORDER BY b.num_likes DESC, a.id ASC LIMIT 5";
